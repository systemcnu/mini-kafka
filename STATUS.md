...
**Updated: 2026-07-29.** Project authority for this repo. Lab/process view: `~/skills/process/LAB-STATE.md`.
...
- **Open partial proofs (SD-5 tracking):** LOG-1/PROD-2 half (b) kill -9 — CLOSED at SL1 · LOG-4 scripted-fault proofs — CLOSED at SL1 · CONS-1 multi-entry service → SL2 · TOP-2 doc-audit half → SL6 · scenario C group-positions half → SL2 (harness ready). CI-green-on-GitHub: CLOSED 2026-07-28 (run green on 82fa448 — staticcheck caught 2 dead helpers on the first real run; fixed).
- **PUBLISHED: github.com/systemcnu/mini-kafka (public, CI green at HEAD).** Sri authorized on-their-behalf pushes for this repo (2026-07-28). **Next: SL2 (consumer groups, 4.5d — the headline feature) when invoked.** Showcase feasibility: PASS receipt on file.
